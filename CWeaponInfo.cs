...
namespace CWeaponInfoTests
{
    ...
    public unsafe struct CWeaponInfo
    {
        ...
        [FieldOffset(0x0320)] public NativeVector3Float FirstPersonRNGOffset;
        [FieldOffset(0x0330)] public NativeVector3Float FirstPersonRNGRotationOffset;
        [FieldOffset(0x0340)] public NativeVector3Float FirstPersonLTOffset;
        [FieldOffset(0x0350)] public NativeVector3Float FirstPersonLTRotationOffset;
        [FieldOffset(0x0360)] public NativeVector3Float FirstPersonScopeOffset;
        [FieldOffset(0x0370)] public NativeVector3Float FirstPersonScopeAttachmentOffset;
        [FieldOffset(0x0380)] public NativeVector3Float FirstPersonScopeRotationOffset;
        [FieldOffset(0x0390)] public NativeVector3Float FirstPersonScopeAttachmentRotationOffset;
        [FieldOffset(0x03A0)] public NativeVector3Float FirstPersonAsThirdPersonIdleOffset;
        [FieldOffset(0x03B0)] public NativeVector3Float FirstPersonAsThirdPersonRNGOffset;
        [FieldOffset(0x03C0)] public NativeVector3Float FirstPersonAsThirdPersonLTOffset;
        [FieldOffset(0x03D0)] public NativeVector3Float FirstPersonAsThirdPersonScopeOffset;
        [FieldOffset(0x03E0)] public NativeVector3Float FirstPersonAsThirdPersonWeaponBlockedOffset;
        [FieldOffset(0x03F0)] public float FirstPersonDofSubjectMagnificationPowerFactorNear;
        [FieldOffset(0x03F4)] public float FirstPersonDofMaxNearInFocusDistance;
        [FieldOffset(0x03F8)] public float FirstPersonDofMaxNearInFocusDistanceBlendLevel;

        [FieldOffset(0x0410)] public float ZoomFactorForAccurateMode;

        [FieldOffset(0x0420)] public NativeVector3Float AimOffsetMin;
        [FieldOffset(0x0430)] public NativeVector3Float AimOffsetMax;
        [FieldOffset(0x0440)] public NativeVector2Float TorsoAimOffset;
        [FieldOffset(0x0448)] public NativeVector2Float TorsoCrouchedAimOffset;
        [FieldOffset(0x0450)] public float AimProbeLengthMin;
        [FieldOffset(0x0454)] public float AimProbeLengthMax;

        [FieldOffset(0x0460)] public NativeVector3Float AimOffsetMinFPSIdle;
        [FieldOffset(0x0470)] public NativeVector3Float AimOffsetMedFPSIdle;
        [FieldOffset(0x0480)] public NativeVector3Float AimOffsetMaxFPSIdle;
        [FieldOffset(0x0490)] public NativeVector3Float AimOffsetMinFPSLT;
        [FieldOffset(0x04A0)] public NativeVector3Float AimOffsetMaxFPSLT;
        [FieldOffset(0x04B0)] public NativeVector3Float AimOffsetMinFPSRNG;
        [FieldOffset(0x04C0)] public NativeVector3Float AimOffsetMaxFPSRNG;
        [FieldOffset(0x04D0)] public NativeVector3Float AimOffsetMinFPSScope;
        [FieldOffset(0x04E0)] public NativeVector3Float AimOffsetMaxFPSScope;
        [FieldOffset(0x04F0)] public NativeVector3Float AimOffsetEndPosMinFPSIdle;
        [FieldOffset(0x0500)] public NativeVector3Float AimOffsetEndPosMedFPSIdle;
        [FieldOffset(0x0510)] public NativeVector3Float AimOffsetEndPosMaxFPSIdle;

        [FieldOffset(0x0570)] public NativeVector3Float LeftHandIkOffset;

        [FieldOffset(0x0580)] public float IkRecoilDisplacement;
        [FieldOffset(0x0584)] public float IkRecoilDisplacementScope;
        [FieldOffset(0x0588)] public float IkRecoilDisplacementScaleBackward;
        [FieldOffset(0x058C)] public float IkRecoilDisplacementScaleVertical;
        [FieldOffset(0x0590)] public NativeVector2Float ReticuleHudPosition;
        [FieldOffset(0x0598)] public NativeVector2Float ReticuleHudPositionOffsetForPOVTurret;
        [FieldOffset(0x05A0)] public float ReticuleMinSizeStanding;
        [FieldOffset(0x05A4)] public float ReticuleMinSizeCrouched;
        [FieldOffset(0x05A8)] public float ReticuleScale;
        [FieldOffset(0x05AC)] public uint ReticuleStyleHash;
        [FieldOffset(0x05B0)] public uint FirstPersonReticuleStyleHash;
        [FieldOffset(0x05B4)] public uint PickupHash;
        [FieldOffset(0x05B8)] public uint MPPickupHash;
        [FieldOffset(0x05BC)] public uint HumanNameHash;

        [FieldOffset(0x05C4)] public uint MovementModeConditionalIdle;

        [FieldOffset(0x05F0)] private IntPtr statNameStrPtr;
        [FieldOffset(0x05F8)] public int KnockdownCount;
        [FieldOffset(0x05FC)] public float KillshotImpulseScale;
        [FieldOffset(0x0600)] public uint NmShotTuningSet;
        [FieldOffset(0x0604)] private AttachPointInfo attachPointsArrayStart;
        [FieldOffset(0x08C0)] public uint AttachPointsCount;
        [FieldOffset(0x08F4)] public uint GunFeedBoneId;
        [FieldOffset(0x0900)] public eWeaponFlags1 WeaponFlags1;
        [FieldOffset(0x0908)] public eWeaponFlags2 WeaponFlags2;
        [FieldOffset(0x08C8)] public eWeaponFlags3 WeaponFlags3;
        [FieldOffset(0x08D0)] public CWeaponTintSpecValues* TintSpecValues;
        [FieldOffset(0x0920)] public CWeaponFiringPatternAliases* FiringPatternAliases;
        [FieldOffset(0x0928)] public CWeaponUpperBodyFixupExpressionData* ReloadUpperBodyFixupExpressionData;
        [FieldOffset(0x0930)] public uint TargetSequenceGroup;
        [FieldOffset(0x0934)] public float BulletDirectionOffsetInDegrees;
        [FieldOffset(0x0938)] public float BulletDirectionPitchOffset;
        [FieldOffset(0x093C)] public float BulletDirectionPitchHomingOffset;

        [FieldOffset(0x0958)] public float VehicleAttackAngle;
